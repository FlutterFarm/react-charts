...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        selectedLinkId: null,
        selectedOperatorBackground: null,
...
//                    console.log($(this).data('operator_id'))
//                    self.selectOperatorBackground($(this).data('operator_background_color'));
//                    console.log($(this).data('operator_background_color'));
                }
            });
        ...
        getLinkMainWidth: function (linkId) {
            var color = this.options.linkWidth;
            var linkData = this.data.links[linkId];
            if (typeof linkData.toLinkWidth != 'undefined') {
                color = linkData.toLinkWidth;
            }
            return color;
        },        
        ...
        setLinkWidth: function (linkId, color) {
            this.data.links[linkId].toLinkWidth = color;
//            $("#" + linkId).css('stroke-width', color);
            this.callbackEvent('afterChange', ['linkwidth_changed']);
        },
        ...
        _drawLink: function (linkId) {
            ...
            var linkWidth = linkData.toLinkWidth;
            console.log("link of width");
...
//            shape_path.setAttribute('data-link_id', linkId);            
            shape_path.setAttribute("stroke-width", linkWidth);
...
//            $operator_background_color.css('background-color', infos.backgrondColor);
        ...
        _getOperatorFullElement1: function (operatorData,operatorId) {
            console.log("opera");
            console.log(operatorData);
            var infos = this.getOperatorCompleteData(operatorData);
...
//            $operator_background_color.css('background-color', infos.backgrondColor);
        ...
        createOperator: function (operatorId, operatorData) {
            ...
            console.log(operatorData['properties']['backgrondColor']);
            this._refreshInternalProperties(operatorData);

            var fullElement = this._getOperatorFullElement1(operatorData,operatorId);
        ...
        getSelectedOperatorBackground: function () {
            console.log("called header");
            return this.selectedOperatorBackground;
        },        
        ...
        colorizeLink: function (linkId, color) {
            ...
            linkData.internal.els.path.setAttribute('stroke', color);            
            linkData.internal.els.path.setAttribute('stroke-width',linkData['toLinkWidth']);
            if (this.options.verticalConnection) {
        ...
        setOperatorBackground: function (operatorId, title) {
            ...
            this.data.operators[operatorId].properties.backgrondColor = title;
            this._refreshInternalProperties(this.data.operators[operatorId]);
            this.callbackEvent('afterChange', ['operator_title_change']);
        },        
        ...
        getOperatorBackgroundColor: function (operatorId) {
            console.log("onclick");
